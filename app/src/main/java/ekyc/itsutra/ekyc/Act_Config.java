...
public class Act_Config extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mllDeviceCtrl = (LinearLayout) this.findViewById(R.id.llBTconnection);
        ...
        btn_Scanbt = (Button) findViewById(R.id.btnBluetoothScan);
    ...
    private void showDeviceInfo() {
        ...
        this.mtvDeviceInfo.setText(
                String.format(getString(R.string.actMain_device_info), this.mhtDeviceInfo.get("NAME"),
    ...
    public void evt_Exit(View view) {
        dlgExit();
    }
    ...
    private class startBluetoothDeviceTask extends AsyncTask<String, String, Integer> {
        ...
        public void onPreExecute() {
            mpd = new ProgressDialog(Act_Config.this);
        ...
        public void onPostExecute(Integer result) {
            ...
            if (RET_BLUETOOTH_START_FAIL == result) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Act_Config.this);
    ...
    private class PairTask extends AsyncTask<String, String, Integer> {
        ...
        public void onPreExecute() {
            ...
            Toast.makeText(Act_Config.this, getString(R.string.actMain_msg_bluetooth_Bonding), Toast.LENGTH_SHORT).show();
        ...
        public void onPostExecute(Integer result) {
            ...
            if (RET_BOND_OK == result) {
                Toast.makeText(Act_Config.this, getString(R.string.actMain_msg_bluetooth_Bond_Success), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(Act_Config.this, getString(R.string.actMain_msg_bluetooth_Bond_fail), Toast.LENGTH_LONG).show();
                try {
    ...
    private class connSocketTask extends AsyncTask<String, String, Integer> {
        ...
        public void onPreExecute() {
            ...
            this.mpd = new ProgressDialog(Act_Config.this);
        ...
        public void onPostExecute(Integer result) {
            ...
            if (CONN_SUCCESS == result) {
                ...
                Toast.makeText(Act_Config.this, getString(R.string.actMain_msg_device_connect_succes), Toast.LENGTH_SHORT).show();
                showBaudRateSelection();

            } else {
                Toast.makeText(Act_Config.this, getString(R.string.actMain_msg_device_connect_fail), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void showBaudRateSelection() { //TODO
        ...
        radioBtn9600.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dlgRadioBtn.dismiss();
                Intent all_intent = new Intent(getApplicationContext(), Act_Main.class);
        ...
        ibc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dlgRadioBtn.dismiss();
                Intent all_intent = new Intent(getApplicationContext(), Act_Config.class);
                all_intent.putExtra("connected", false);
                startActivityForResult(all_intent, 3);
            }
        });
    ...
    public void dlgExit() {
        ...
        alertDialogBuilder.setMessage("Do you want to exit from " + R.string.app_name);
